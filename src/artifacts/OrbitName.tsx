...
export function OrbitName(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group {...props} dispose={null}>
        <mesh geometry={nodes.MissionLaunchText002.geometry} material={materials.M_03___Default} position={[1.117, 3.221, 0]} scale={0.025} />
        <mesh geometry={nodes.Box004.geometry} material={materials.M_08___Default} position={[0.992, 2.799, -0.115]} scale={0.025} />
        <mesh geometry={nodes.MissionLaunchText003.geometry} material={materials.M_03___Default} position={[0.989, 2.338, 0]} scale={0.025} />
    </group>
  )
}
