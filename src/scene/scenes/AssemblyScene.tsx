...
const sceneDateScale = filledVector(0.15);
...
const AssemblyScene: SceneComponent = () => (
  <Explode initialExploded={true}>
    ...
    <ExplodeTrigger>
      <Box position={[0, 4.5, -2]} scale={5}>
        <meshBasicMaterial transparent opacity={0} />
      </Box>
    </ExplodeTrigger>
    <Orbiter position={[0, 4, -2]} scale={orbiterScale} />
    <AssembleTestSceneName position={[0, 11, -2]} scale={sceneNameScale} />
    <AssembleAnimation />
    <AssembleDate scale={sceneDateScale} position={[0, 0, 2]} />
  </Explode>
);
