...
const AssemblyScene: SceneComponent = () => (
  <Explode initialExploded={true}>
    ...
    <hemisphereLight position={[0, -4, 4]} intensity={0.3} color={'white'} />
    ...
    <Orbiter position={[0, 3, 0]} scale={orbiterScale} />
    <AssembleTestSceneName position={[0, 10, -1]} scale={sceneNameScale} />
    <AssembleAnimation />
    <AssembleDate scale={sceneDateScale} position={[0, -3, 5]} />
  </Explode>
);
